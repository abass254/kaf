@extends('front_layout.app', ['pageslug' => 'what_we_do'])
@section('content')
    ...
    <!-- Slider Revolution Start -->
      <div class="rev_slider_wrapper">
        <div class="rev_slider" data-version="5.0">
          <ul>
            <!-- SLIDE 1 -->
            <li data-index="rs-1" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="{{ asset('asset/images/kulmiye/pictures/IMG_1851.JPG') }}"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
              <!-- MAIN IMAGE -->
              <img src="{{ asset('asset/images/kulmiye/pictures/IMG_1851.JPG') }}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="5" data-no-retina>
              <!-- LAYERS -->
              ...
              <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0 text-uppercase"
                ...
                style="z-index: 6; white-space: nowrap;"><span class="text-theme-colored">CASH </span>and Voucher Assistance
              </div>

              <!-- LAYER NR. 2 -->
              <div class="tp-caption BigBold-Title text-uppercase tp-resizeme rs-parallaxlevel-0"
                id="rs-1-layer-2"
                data-x="['left','left','left','left']" 
                data-hoffset="['55','55','33','20']" 
                data-y="['top','bottom','bottom','bottom']" 
                data-voffset="['210','1','74','58']" 
                ...
                data-basealign="slide" 
                data-responsive_offset="on"
                style="z-index: 7; min-width: 410px; max-width: 410px; max-width: 60px; max-width: 60px; white-space: normal;"><span class="text-theme-colored">A Premium Revolution Slider Template for your Website Highlights & Multi-Media Content</span>
              </div>
            ...
            <!-- SLIDE 2 -->
            <li data-index="rs-2" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="{{ asset('asset/images/kulmiye/pictures/IMG_1651.JPG') }}"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
              <!-- MAIN IMAGE -->
              <img src="{{ asset('asset/images/kulmiye/pictures/IMG_1651.JPG') }}" style="opacity: 10%" alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="5" data-no-retina>
              <!-- LAYERS -->
              ...
              <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0 text-uppercase"
                ...
                data-basealign="slide" 
                data-responsive_offset="on"
                style="z-index: 6; white-space: nowrap;"><span class="text-theme-colored">ACCESSIBILITY A</span>ND INCLUSIVENESS 
              </div>
              ...
              <div class="tp-caption BigBold-Title text-uppercase tp-resizeme rs-parallaxlevel-0"
                ...
                data-basealign="slide" 
                data-responsive_offset="on"
                style="z-index: 7; min-width: 410px; max-width: 410px; max-width: 60px; max-width: 60px;"><span class="text-theme-colored">We are inclusive in all our response sectors for people with a disability, and make it easier for them to access services.
              </div>
            ...
            <!-- SLIDE 3 -->
            <li data-index="rs-3" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="{{ asset('asset/images/kulmiye/pictures/IMG_2843.JPG') }}"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
              <!-- MAIN IMAGE -->
              <img src="{{ asset('asset/images/kulmiye/pictures/IMG_2843.JPG') }}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="5" data-no-retina>
              <!-- LAYERS -->
              ...
              <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0 text-uppercase"
                ...
                data-basealign="slide" 
                data-responsive_offset="on"
                style="z-index: 6; white-space: nowrap;"><span class=" text-theme-colored">Healthcare </span>and nutrition
              </div>
            ...
            <li data-index="rs-4" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="{{ asset('asset/images/kulmiye/pictures/IMG_3563.JPG') }}"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
              <!-- MAIN IMAGE -->
              <img src="{{ asset('asset/images/kulmiye/pictures/IMG_3563.JPG') }}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="5" data-no-retina>
              <!-- LAYERS -->
              ...
              <!-- LAYER NR. 2 -->
              <div class="tp-caption text-capitalize BigBold-Title text-capitalize tp-resizeme rs-parallaxlevel-0"
                id="rs-4-layer-2"
          ...
          <div class="col-md-12">
            <div class="gallery-isotope grid-5 gutter-small clearfix" data-lightbox="gallery">
              ...
              <div class="gallery-item">
                <div class="thumb">
                  <img alt="project" src="http://placehold.it/310x215" class="img-fullwidth">
